...
<div x-data="{ openRow: null }">
    ...
    {{-- HEADER --}}
    <h1 class="text-2xl font-bold mb-4">Tarif Durasi</h1>
    ...
    <div class="bg-white rounded-lg shadow overflow-x-auto">
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                @forelse ($tarifDurasi as $item)

                    @php
                        $prevBatas = $loop->first
                            ? 0
                            : $tarifDurasi[$loop->index - 1]->batas_jam + 1;
                    @endphp
